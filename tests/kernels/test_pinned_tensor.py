...
def test_host_device_ptr_is_identity_under_uva():
    ...
    if _host_ptr_identity():
        ...
        # support). That is exactly why device_ptr must not call it here. Upstream #132
        # assumed the raw call degenerates to identity under UVA; that does not hold on this
        # platform, so this fork keeps the measured behavior as the contract.
